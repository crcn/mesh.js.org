...
var features = [
  ...
  {
    title: "Testable",
    desc : "Mesh makes easy to test service level code. Just swap out the service adapter for a fake one.",
    icon: "beaker"
  },
  {
    title: "Works with APIs",
    desc: "Easily <a href='/docs/database-adapters'>write adapters</a> for your <a href='https://github.com/mojo-js/mesh.js/tree/master/examples/api'>service API</a> and unlock the ability to interoperate with other mesh <a href='https://www.npmjs.com/search?q=meshjs'>plugins</a>.",
    icon: "heart"
  }
]
